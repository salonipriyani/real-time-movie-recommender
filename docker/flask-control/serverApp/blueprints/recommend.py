...
all_df = pd.read_csv(os.getenv("RATINGS_PATH", "modeling/baseline_train.csv"))
...
SVD_MODEL_DIR = os.path.abspath(os.getenv("MODEL_DUMP_PATH", "modeling/SVD_baseline.dump"))
_, user_algo2 = dump.load(SVD_MODEL_DIR)
...
def recommend(user_id):
    ...
    log_recommendation(user_id_int, recommendString)
