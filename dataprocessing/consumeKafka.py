...
from dataprocessing.base import Session, engine, Base
from dataprocessing.models import Rating, RatingAverage
...
if __name__ == "__main__":
    ...
    last_timestamp = datetime.now() - relativedelta(seconds=300)
    ...
    for data in consumer:
        ...
        if temp_timestamp:
            last_timestamp = temp_timestamp - relativedelta(seconds=300)
